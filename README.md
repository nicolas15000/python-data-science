...
L'idée étant de pouvoir résoudre un certain nombre de problèmes pour des pme , les confirmer par comparaisons de résultats ( Par exemple, comparaison Excel solveur / Python Pulp), et de pouvoir les dériver un peu, tout en ayant un niveau faible en pure théorie pour le moment.
